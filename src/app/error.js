  ...
  return (
    <div className="flex flex-col justify-center h-screen items-center p-3">
      ...
      <div className={'flex justify-center items-center gap-10'}>
          ...
          <Button onClick={() => window.location.reload()} variant={'solid'} color={'primary'} size={'lg'} className="text-white mt-5 flex justify-center items-center gap-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><LuRefreshCw /> Refresh</Button>
      </div>
    </div>
  );
}
